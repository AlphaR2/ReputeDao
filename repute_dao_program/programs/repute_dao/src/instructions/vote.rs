...
pub struct Vote<'info> {
    ...
    #[account(
        ...
        bump,
        constraint = target_user_registry.claimed @ ReputeDaoError::UsernameNotFound
    )]
    ...
    #[account(
        ...
        bump,
        constraint = target_user_profile.owner == target_user_registry.owner @ ReputeDaoError::ProfileMismatch
    )]
...
impl<'info> Vote<'info> {
    ...
    fn cast_vote(
        ...
        require!(
            ...
            ReputeDaoError::CannotVoteForSelf
        );
        ...
        if cooldown_hours > 0 {
            ...
            require!(
                ...
                ReputeDaoError::VoteCooldownActive
            );
        }
